...
${OBJECTDIR}/src/fbxmath.o: src/fbxmath.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fbxmath.o src/fbxmath.cpp

${OBJECTDIR}/src/fbxscene.o: src/fbxscene.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fbxscene.o src/fbxscene.cpp

${OBJECTDIR}/src/fbxutil.o: src/fbxutil.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/fbxutil.o src/fbxutil.cpp

${OBJECTDIR}/src/loadfbx.o: src/loadfbx.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/loadfbx.o src/loadfbx.cpp

${OBJECTDIR}/src/variant.o: src/variant.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/variant.o src/variant.cpp
