...
LDLIBSOPTIONS=-lGL -lglut -Wl,-rpath,../dist/Debug/GNU-Linux -L../dist/Debug/GNU-Linux -lopenfbx

# Build Targets
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/loadfbx

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/loadfbx: ../dist/Debug/GNU-Linux/libopenfbx.so
